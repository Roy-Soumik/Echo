        ...
        >
          <div className="flex flex-col gap-7 border-b border-black-5 pb-10">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  ...
                  <FormControl>
                    <Input type="text"
                      className="input-class focus-visible:ring-offset-cyan-500"
            ...
            <div className="flex flex-col gap-2.5">
              ...
              >
                <SelectTrigger
                  className={cn(
                    "text-16 w-full bg-black-1 text-gray-1 border-none focus-visible:ring-offset-cyan-500"
                  )}
                >
                  <SelectValue
                    ...
                    <SelectGroup key={voice.provider}>
                      ...
                      {voice.voices.map((voiceName) => (
                        <SelectItem
                          ...
                          className="capitalize focus:bg-cyan-500"
                        >
                          {voiceName}
                        </SelectItem>
                      ))}
          ...
          <div className="flex flex-col pt-10">
            ...
            <div className="mt-10 w-full">
              <Button
                type="submit"
                className="text-16 w-full bg-cyan-500 py-4 font-extrabold text-white-1 transition-all duration-500 hover:bg-black-2"
              >
                {isSubmitting ? (
                  <>
                    Submitting...
